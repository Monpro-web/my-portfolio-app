    ...
    <> 
      <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%]
                        ...
                        ${isScroll?
                          "bg-white bg-opasity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20 ":""}`}>
            <a href="#top">
                <Image src={isDarkMode ? assets.suyoLogoWhite : assets.suyoLogoBlack} alt='' className='w-20 cursor-pointer mr-14 ' />
            </a>
