...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "8e4d5d8d-4f6e-49a3-afa6-4ac71528e60c");
    ...
    <motion.div 
        ...
        className='text-center mb-2 text-lg font-Ovo'>
         ...
         className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            ...
            Dolorum qui assumenda sit perferendis vel distinctio voluptatibus 
            dolores enim laboriosam placeat?
         </motion.p>
         <motion.form 
          initial={{opacity:0}}
          animate={{opacity:1}}
         ...
         className='max-w-2xl mx-auto' onSubmit={onSubmit}>
            <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
                ...
                bg-white rounded-md dark:bg-darkHover/30 dark:border-white/90' name='name'/>
                ...
                className='flex-1 p-3 outline-none border-[0.5px] border-gray-400
                bg-white rounded-md dark:bg-darkHover/30 dark:border-white/90' name='email'/>
            ...
            className='w-full p-4 outline-none border-[0.5px] border-gray-400
                bg-white rounded-md mb-6 dark:bg-darkHover/30 dark:border-white/90' 
                name='message'>
